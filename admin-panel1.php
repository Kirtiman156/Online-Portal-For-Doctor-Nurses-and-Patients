...
if(isset($_POST['docsub']))
{
  ...
  $query=mysqli_query($con, "INSERT INTO doctb(username,password,email,spec,docFees) VALUES('$doctor','$dpassword','$demail','$spec','$docFees')");
  $result=True;
  if($result)
    {
...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family: 'IBM Plex Sans', sans-serif;"> WELCOME NURSE </h3>
    <div class="row">
